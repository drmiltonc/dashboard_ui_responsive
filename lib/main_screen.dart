      ...
      drawer: NavigationDrawer(
          ...
          children: const [
            ...
            NavigationDrawerDestination(
                icon: Icon(Icons.person_2_rounded), label: Text('Profile')),
            NavigationDrawerDestination(
                icon: Icon(Icons.settings), label: Text('Account Settings')),
            NavigationDrawerDestination(
                icon: Icon(Icons.shopping_cart_checkout_rounded),
                label: Text('Cart')),
            NavigationDrawerDestination(
                icon: Icon(Icons.list_alt_rounded), label: Text('Orders')),
            NavigationDrawerDestination(
